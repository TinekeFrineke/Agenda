...
WorkAndPlayDialog::WorkAndPlayDialog(Agenda::Agenda & agenda, Settings & settings, CWnd* pParent /*=NULL*/)
...
void WorkAndPlayDialog::DoDataExchange(CDataExchange* pDX)
{
  CDialogEx::DoDataExchange(pDX);
  DDX_Control(pDX, IDC_AGENDA_TAB, m_TabControl);
}

BEGIN_MESSAGE_MAP(WorkAndPlayDialog, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
  ON_NOTIFY(TCN_SELCHANGE, IDC_AGENDA_TAB, &WorkAndPlayDialog::OnTcnSelchangeAgendaTab)
END_MESSAGE_MAP()


// AgendaDialog message handlers

BOOL WorkAndPlayDialog::OnInitDialog()
{
...
void WorkAndPlayDialog::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void WorkAndPlayDialog::OnPaint()
{
	if (IsIconic())
	{
...
HCURSOR WorkAndPlayDialog::OnQueryDragIcon()
{
...
void WorkAndPlayDialog::OnTcnSelchangeAgendaTab(NMHDR * /*pNMHDR*/, LRESULT *pResult)
{
...
BOOL WorkAndPlayDialog::PreTranslateMessage(MSG* pMsg)
{
